...
angular.module('narra.ui').controller 'LayoutsSequencePlayerWithMetadataCtrl', ($scope, $sce, $timeout, $routeParams, $window, $rootScope, $q, apiProject, apiVisualization, elzoidoPromises) ->
  # player
  $scope.player =
    api: undefined
    ready: false
