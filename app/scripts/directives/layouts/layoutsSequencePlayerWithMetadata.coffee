...
angular.module('narra.ui').directive 'layoutsSequencePlayerWithMetadata', ->
  restrict: 'A'
  transclude: true
  scope:
    project: '=narraProject'
    layout: '=narraLayout'
  controller: 'LayoutsSequencePlayerWithMetadataCtrl'
  templateUrl: 'partials/layouts/layoutsSequencePlayerWithMetadata.html'
  replace: false