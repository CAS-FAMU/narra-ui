...
angular.module('narra.ui').directive 'layoutsSequencePlayerOnly', ->
  restrict: 'A'
  transclude: true
  scope:
    project: '=narraProject'
    layout: '=narraLayout'
  controller: 'LayoutsSequencePlayerOnlyCtrl'
  templateUrl: 'partials/layouts/layoutsSequencePlayerOnly.html'
  replace: false