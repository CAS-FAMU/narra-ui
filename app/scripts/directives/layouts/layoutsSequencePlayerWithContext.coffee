...
angular.module('narra.ui').directive 'layoutsSequencePlayerWithContext', ->
  restrict: 'A'
  transclude: true
  scope:
    project: '=narraProject'
    layout: '=narraLayout'
  controller: 'LayoutsSequencePlayerWithContextCtrl'
  templateUrl: 'partials/layouts/layoutsSequencePlayerWithContext.html'
  replace: false