...
angular.module('narra.ui').directive 'layoutsVisualizationOnly', ->
  restrict: 'A'
  transclude: true
  scope:
    project: '=narraProject'
    layout: '=narraLayout'
  controller: 'LayoutsVisualizationOnlyCtrl'
  templateUrl: 'partials/layouts/layoutsVisualizationOnly.html'
  replace: false