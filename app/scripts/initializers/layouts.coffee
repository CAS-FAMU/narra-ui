...
angular.module('narra.ui').constant 'constantLayouts',
  layouts: [
    {
      ...
      template: 'partials/layouts/layoutVisualizationOnly.html',
      controller: 'LayoutVisualizationOnlyCtrl'
    }
    {
      id: 'player_only',
      name: 'Player Only',
      ...
      template: 'partials/layouts/layoutPlayerOnly.html',
      controller: 'LayoutPlayerOnlyCtrl'
    }
  ]